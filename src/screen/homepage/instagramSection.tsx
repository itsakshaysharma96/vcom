...
export function InstagramSection() {
  return (
    <section id="bts" className="w-full px-6 py-16">
      <div className="max-w-7xl mx-auto">
        <div className="md:flex justify-between gap-8 items-center">

          <div className="space-y-6 flex items-start md:px-20 px-10 py-20 md:py-0 flex-col md:w-2/3 justify-center md:h-[-webkit-fill-available] bg-background">
            <div>
              ...
              before:border-t-[.5px] before:top-7 before:absolute before:border-black before:left-0
               after:w-[2rem] after:top-7 after:absolute after:border-t-[.5px] after:right-0 after:border-black">Follow Us</p>
            </div>
          </div>
